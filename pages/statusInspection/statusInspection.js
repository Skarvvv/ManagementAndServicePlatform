// pages/statusInspection/statusInspection.js
...
Page({
  ...
  updateStatusContent: function(e){
    this.setData({
      statusContent: e.detail.value
    })
  },
  updateLowTemp: function(e){
    this.setData({
      lowTemp: e.detail.value
    })
  },
  updateHighTemp: function(e){
    this.setData({
      highTemp: e.detail.value
    })
  },
  updateCurrentTemp: function(e){
    this.setData({
      currentTemp: e.detail.value
    })
  },
  submitStatusInspection: function(){
    const app = getApp();
    wx.request({
      url: app.globalData.requestAddr + '/status/save',
      method: 'GET',
      data: {
        uid: app.globalData.userInfo.uid,
        statusContent: this.data.statusContent,
        stime: this.data.time,
        lowTemp: this.data.lowTemp,
        highTemp: this.data.highTemp,
  ...
  loadStatusInspections: function(){
    const app = getApp();
    wx.request({
      url: app.globalData.requestAddr + '/status/statusInspectionByUid',
      method: 'GET',
      data: {
        uid: app.globalData.userInfo.uid
      },
